...
urlpatterns = [
    path('list_encuestas', views.list_encuestas, name="list_encuestas"),
    path('form/create', views.add_encuesta, name="add_encuesta"),
    path('form/<str:code>/edit', views.edit_encuesta, name="edit_encuesta"),
    path('form/<str:code>/add_question', views.add_question, name="add_question"),
    path('form/<str:code>/repeat_question/<str:question>', views.repeat_question, name="repeat_question"),
    path('form/<str:code>/delete_question/<str:question>', views.delete_question, name="delete_question"),
    #path('form/<str:code>/delete_question/<str:question>', views.delete_question, name="delete_question"),
    path('form/<str:code>/view', views.view_encuesta, name="view_encuesta"),
